...
/**
 * TP-Link HS100 Helper Methods
 *
 * @author Srinivas MD
 * @copyright Copyright (c) 2016, WindchillGuru
 */
public class TPLinkHS100 {
     ...
     */
    public TPLinkHS100(String ip, int port) {
        this.ip = ip;
        this.port = port;
    }
